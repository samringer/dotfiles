...
alias sergei="ssh sergei.firewall-gateway.com"
alias sergeijl="ssh -N -L localhost:8888:localhost:8888 sam@sergei.firewall-gateway.com"
alias sergeitb="ssh -N -L localhost:6006:localhost:6006 sam@sergei.firewall-gateway.com"
