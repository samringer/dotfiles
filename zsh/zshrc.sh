...
alias sergei="ssh samsergei.hopto.org"
alias sergeijl="ssh -N -L localhost:8888:localhost:8888 samsergei.hopto.org"
alias sergeitb="ssh -N -L localhost:6006:localhost:6006 samsergei.hopto.org"
